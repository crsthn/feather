...
const icons: Record<ToastType, React.ReactNode> = {
  loading: <Spinner />,
  success: <CircleCheck className="text-green-600 dark:text-green-500" />,
